...
chain3.invoke({"question":"Consider 2 forces acting on a mass of 2.63 kg. F1 = 9.6 N @ 18.3 degrees and F2 = 8.81 N @ 77.8 degrees where the angles are measured relative to the +x direction. What is the magnitude of the acceleration produced considering only these 2 forces acting?"})
